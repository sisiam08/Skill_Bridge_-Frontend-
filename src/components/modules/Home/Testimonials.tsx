          ...
          {testimonials.map((item, index) => (
            ...
            >
              <CardContent className="p-8 space-y-6">
                <Badge
                  variant="secondary"
                  className="text-[#ec5b13] text-lg bg-transparent p-0 border-0"
                >
                ...
                <CardDescription className="italic text-sm text-[#4b4b4b] dark:text-gray-300 leading-relaxed">
                  &quot;{item.text}&quot;
                </CardDescription>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <CardTitle className="font-bold text-[#221610] dark:text-white text-sm leading-normal">
                      {item.name}
                    </CardTitle>

                    <CardDescription className="text-xs text-gray-500 leading-normal">
                      {item.role}
                    </CardDescription>
                  </div>
                </div>
